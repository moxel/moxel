...
var ImageLib = require('./utils/image.js');
...
var VERSION = 'js-' + pjson.version;
console.log('Moxel client version', VERSION);

var Moxel = function Moxel(config) {
	...
	var Utils = function () {
		...
		_createClass(Utils, null, [{
			key: 'parseModelId',
			value: function parseModelId(modelId) {
			...
			key: 'parseSpaceObject',
			value: function parseSpaceObject(spaceObject) {
				var result = {};
			...
			key: 'encodeQueryParams',
			value: function encodeQueryParams(params) {
	...
	var MasterAPI = function () {
		function MasterAPI() {
			_classCallCheck(this, MasterAPI);
		}

		// Get model metadata from Master Server.


		_createClass(MasterAPI, [{
			key: 'getModel',
			value: function getModel(user, name, tag) {
			...
			key: 'getAssetURL',
			value: function getAssetURL(user, name, tag, path, verb, contentType) {
				if (!path.startsWith('/')) {
				...
				return new Promise(function (resolve, reject) {
					...
					fetch(API_ENDPOINT + ('/url/data?' + Utils.encodeQueryParams(params)), {
						method: 'GET'
			...
			key: 'putExample',
			value: function putExample(user, name, tag, exampleId, clientLatency) {
			...
			key: 'putDemoExample',
			value: function putDemoExample(user, name, tag, exampleId) {
				var clientVersion = VERSION;
				return new Promise(function (resolve, reject) {
			...
			key: 'listExample',
			value: function listExample(user, name, tag) {
				return new Promise(function (resolve, reject) {
			...
			key: 'listDemoExample',
			value: function listDemoExample(user, name, tag) {
				return new Promise(function (resolve, reject) {
	...
	var Image = function () {
		...
		_createClass(Image, [{
			...
			value: function shape() {
				return [this.img.bitmap.height, this.img.bitmap.width];
			}
			...
			value: function toDataURL(mime) {
				...
				var self = this;
				return new Promise(function (resolve, reject) {
					self.toBase64(mime).then(function (data) {
			...
			key: 'toBase64',
			value: function toBase64(mime) {
				if (!mime) {
					mime = 'image/png';
				}
				var self = this;
				return new Promise(function (resolve, reject) {
					self.toBytes(mime).then(function (data) {
			...
			value: function fromBytes(data) {
				...
				return new Promise(function (resolve, reject) {
					ImageLib.fromBytes(data).then(function (result) {
	...
	var MoxelArray = function () {
		_createClass(MoxelArray, null, [{
			key: 'type',
			get: function get() {
				return "array";
			}
		...
		function MoxelArray(array) {
			_classCallCheck(this, MoxelArray);
	...
	var MoxelBytes = function () {
		_createClass(MoxelBytes, null, [{
			key: 'type',
			get: function get() {
				return "bytes";
			}
		...
		function MoxelBytes(data) {
			_classCallCheck(this, MoxelBytes);

			this.data = data;
			this.toBase64 = this.toBase64.bind(this);
		}

		_createClass(MoxelBytes, [{
			key: 'toBase64',
	...
	var MoxelFloat = function () {
		_createClass(MoxelFloat, null, [{
			key: 'type',
			get: function get() {
				return "float";
			}
		...
		function MoxelFloat(x) {
			_classCallCheck(this, MoxelFloat);
	...
	var MoxelInt = function () {
		_createClass(MoxelInt, null, [{
			key: 'type',
			get: function get() {
				return "int";
			}
	...
	var MoxelBoolean = function () {
		_createClass(MoxelBoolean, null, [{
			key: 'type',
			get: function get() {
				return "bool";
			}
		...
		function MoxelBoolean(x) {
			_classCallCheck(this, MoxelBoolean);
	...
	var MoxelString = function () {
		_createClass(MoxelString, null, [{
			key: 'type',
			get: function get() {
				return "str";
			}
		...
		function MoxelString(text) {
			_classCallCheck(this, MoxelString);
	...
	var MoxelJSON = function () {
		_createClass(MoxelJSON, null, [{
			key: 'type',
			get: function get() {
				return "json";
			}
		...
		function MoxelJSON(object) {
			_classCallCheck(this, MoxelJSON);
	...
	var Model = function () {
		function Model(user, name, tag, result) {
		...
		_createClass(Model, [{
			key: 'formatMetadata',
			value: function formatMetadata(newMetadata) {
				var metadata = {
					title: "Untitled",
			...
			key: '_store',
			value: function _store(inputBlob, outputBlob, assets) {
				var self = this;
				...
				return new Promise(function (resolve, reject) {
					...
					masterAPI.getAssetURL(self.user, self.name, self.tag, '/examples/' + exampleId, 'PUT').then(function (url) {
						...
						for (var key in assets) {
							...
							masterAPI.getAssetURL(self.user, self.name, self.tag, '/examples/' + exampleId + '/' + key, 'PUT', 'image/png').then(function (url) {
								console.log("Generated asset url " + url);
								return fetch(url, {
									method: 'PUT',
									body: asset
			...
			key: 'encode',
			value: function encode(data, dataSpace) {
				if (!data) {
				...
				return new Promise(function (resolve, reject) {
					var blob = {};
					async.forEachOf(dataSpace, function (varSpace, varName, callback) {
						...
						if (varSpace == space.image) {
							// Image.
							data[varName].toBase64('image/png').then(function (item) {
								blob[varName] = item;
								callback();
							});
						} else if (varSpace == space.str || varSpace == space.float || varSpace == space.int || varSpace == space.bool) {
							data[varName].toText().then(function (text) {
								blob[varName] = text;
								callback();
							});
						} else if (varSpace == space.json) {
							data[varName].toObject().then(function (object) {
								blob[varName] = object;
								callback();
							});
						} else if (varSpace == space.bytes) {
							data[varName].toBase64().then(function (b64) {
								blob[varName] = b64;
								callback();
							});
						} else if (varSpace == space.array) {
							data[varName].toJSON().then(function (json) {
								blob[varName] = json;
								callback();
							});
						} else {
			...
			key: 'decode',
			value: function decode(blob, dataSpace) {
				if (!blob) {
				...
				return new Promise(function (resolve, reject) {
					...
					async.forEachOf(dataSpace, function (varSpace, varName, callback) {
						if (varSpace == space.image) {
							space.image.fromBase64(blob[varName]).then(function (outputItem) {
								outputObject[varName] = outputItem;
								callback();
							});
						} else if (varSpace == space.json) {
							space.json.fromObject(blob[varName]).then(function (outputItem) {
								outputObject[varName] = outputItem;
								callback();
							});
						} else if (varSpace == space.str || varSpace == space.int || varSpace == space.bool || varSpace == space.float) {
							space.str.fromText(blob[varName]).then(function (outputItem) {
								outputObject[varName] = outputItem;
								callback();
							});
						} else if (varSpace == space.array) {
							space.array.fromJSON(blob[varName]).then(function (outputItem) {
								outputObject[varName] = outputItem;
								callback();
							});
						} else {
			...
			key: '_loadExample',
			value: function _loadExample(exampleId, demo) {
				var self = this;

				return new Promise(function (resolve, reject) {
					masterAPI.getAssetURL(self.user, self.name, self.tag, '/examples/' + exampleId, 'GET').then(function (url) {
						return fetch(url, {
							method: 'GET',
							headers: {
								'Content-Type': 'application/octet-stream'
						...
						var inputObject = {};
						var outputObject = {};
						self.decode(result.input, self.inputSpace).then(function (object) {
							inputObject = object;
			...
			key: 'loadExampleAsset',
			value: function loadExampleAsset(exampleId, assetKey) {
				var self = this;
			...
			key: 'loadRuntimeExample',
			value: function loadRuntimeExample(exampleId) {
				return this._loadExample(exampleId, false, assets);
			}
		}, {
			key: 'loadDemoExample',
			value: function loadDemoExample(exampleId) {
				return this._loadExample(exampleId, true);
			}
		}, {
			key: '_saveExample',
			value: function _saveExample(inputObject, outputObject, clientLatency, demo, assets) {
				var self = this;
				var exampleId = null;
			...
			key: 'saveRuntimeExample',
			value: function saveRuntimeExample(inputObject, outputObject, clientLatency, assets) {
				return this._saveExample(inputObject, outputObject, clientLatency, false, assets);
			}
		}, {
			key: 'saveDemoExample',
			value: function saveDemoExample(inputObject, outputObject, assets) {
				return this._saveExample(inputObject, outputObject, null, true, assets);
			}
		}, {
			key: '_listExamples',
			value: function _listExamples(demo) {
				var self = this;

				return new Promise(function (resolve, reject) {
					if (demo) {
						masterAPI.listDemoExample(self.user, self.name, self.tag).then(function (result) {
							resolve(result);
						}).catch(function (err) {
							reject(err);
						});
					} else {
						masterAPI.listExample(self.user, self.name, self.tag).then(function (result) {
							resolve(result);
						}).catch(function (err) {
							reject(err);
						});
			...
			key: 'listRuntimeExamples',
			value: function listRuntimeExamples() {
				return this._listExamples(false);
			}
		}, {
			key: 'listDemoExamples',
			value: function listDemoExamples() {
			...
			value: function predict(kwargs) {
				...
				return new Promise(function (resolve, reject) {
					...
					self.encode(kwargs, self.inputSpace).then(function (blob) {
						inputBlob = blob;
	...
	function createModel(modelId) {
		return new Promise(function (resolve, reject) {
			...
			masterAPI.getModel(user, name, tag).then(function (result) {
...
},{"../package.json":12,"./utils/image.js":2,"async":3,"buffer":14,"es6-promise":6,"file-type":7,"isomorphic-fetch":9,"md5":10}],2:[function(require,module,exports){
(function (Buffer){
'use strict';
...
module.exports = {
    fromBytes: function fromBytes(data) {
        return new Promise(function (resolve, reject) {
...
},{"charenc":4,"crypt":5,"is-buffer":8}],11:[function(require,module,exports){
(function(self) {
  'use strict';
...
module.exports={
  "name": "moxel",
  "version": "0.0.3",
  "description": "Javascript client for Moxel",
  "main": "src/index.js",
  "scripts": {
    "test": "mocha",
    "build": "./node_modules/.bin/babel  --presets es2015,stage-0 -d lib src; "
  },
  "author": "Moxel",
  "license": "ISC",
  "dependencies": {
  ...
  "browser": {
      "./lib/utils/image.js": "./lib/utils/image-browser.js"
  }
}
